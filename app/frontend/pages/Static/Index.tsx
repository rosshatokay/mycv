		...
		<>
			...
			<div className="py-20">
				<div className="large-container">
					...
					<div className="mt-30">
						<video src="https://www.uselayo.com/videos/marketing-video.mp4" autoPlay muted loop className="rounded-xl"></video>
						{/* <div className="rounded-xl w-full flex p-[4%_12%] pb-0 overflow-hidden justify-center sm:h-165" style={{ background: `url(https://images.unsplash.com/photo-1596367407372-96cb88503db6?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D) center / cover` }}> */}
