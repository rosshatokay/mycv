			...
			<div className="flex h-screen overflow-hidden">
				<div className="w-full overflow-auto">
					<div className="relative h-full">
						<div className="relative z-10 mx-auto py-8 sm:w-max sm:py-24">
							...
							<div className="mx-auto w-full bg-surface-white px-4 py-6 sm:w-96 sm:rounded-lg">
								<h1 className="text-xl font-medium leading-5 tracking-tight text-ink-gray-9 mb-2">Sign in to your Mycv account</h1>
								<p className="text-subtle text-sm">Hosting platform for Frappe apps</p>
								<div className="mt-6">
										...
										<FieldSet>
											<FieldGroup>
												...
												<Field>
													...
													<Input id="password" className="h-10 px-3" type="password" autoComplete="off" placeholder="Enter your password" />
									...
									<div className="mt-6 text-subtle">
										...
										<div className="text-sm">By continuing, you agree to Mycv's <a className="underline text-foreground">Terms of use</a> and <a className="underline text-foreground">Privacy policy</a>.</div>
									</div>
								</div>
							</div>
